...
export default function TOC() {
    ...
    return (
        <ul className="nav nav-pills" id="wd-toc">
            ...
            <li className="nav-item"><a id="wd-github-react" href="https://github.com/jpan0826/kanbas-react-web-app-cs5610-fa24" target="_blank"
            ...
            <li className="nav-item"><a id="wd-server" href="https://kanbas-node-server-app-1-gh0e.onrender.com" target="_blank"
