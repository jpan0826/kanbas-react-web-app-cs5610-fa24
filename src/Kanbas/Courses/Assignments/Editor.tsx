          ...
          <div>
            <div id="wd-assignment-name" className="mb-3">
              ...
              <input type="text" className="form-control"
                id="assignment-name" defaultValue={assignment.title} onChange={(e) => setAssignment({ ...assignment, title: e.target.value })} />
            </div>
            <div id="wd-assignment-instruction" className="mb-3 border rounded p-3">
              ...
              <input type="text" className="form-control"
                id="assignment-instruction" defaultValue={assignment.description} onChange={(e) => setAssignment({ ...assignment, description: e.target.value })} />
            </div>
            ...
            <div className="container">
              ...
              <div id="wd-assignment-points" className="row">
                ...
                <div className="col">
                  <input id="points" type="number" className="form-control" defaultValue={assignment.points} onChange={(e) => setAssignment({ ...assignment, points: e.target.value })} />
                </div>
              </div> <br />


              <div id="wd-assignment-assign" className="row">
                <label className="form-label col text-end">
                  Assign
                </label>
                <div className="col">
                  <div className="card border boder-light rounded">
                    <div className="card-body">
                      ...
                      <div className="col">
                        <input type="datetime-local" defaultValue={assignment.due_timestamp} className="form-control" id="due" onChange={(e) => setAssignment({ ...assignment, due_timestamp: e.target.value })} />
                      </div><br />
                      ...
                      <div className="row">
                        <div className="col-sm">
                          ...
                          <div className="col-sm-5">
                            <input type="datetime-local" defaultValue={assignment.available_timestamp} className="form-control" id="available-from" onChange={(e) => setAssignment({ ...assignment, available_timestamp: e.target.value })} />
                          </div>
                        </div>
                        <div className="col-sm">
                          ...
                          <div className="col-sm-5">
                            <input type="datetime-local" defaultValue={assignment.due_timestamp} className="form-control" id="available-until" onChange={(e) => setAssignment({ ...assignment, due_date: e.target.value })} />
                          </div>
                        </div>
                      </div>
